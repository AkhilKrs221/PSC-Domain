...
const uploadedPdfs = [
  { title: "കേരള ചരിത്രം Quiz", tag: "Kerala History", pdf: `${E:\series\9-1-1}kerala_history_quiz.pdf`, topics: ["കേരള നവോത്ഥാനം", "സാമൂഹിക പരിഷ്കരണം", "PSC ആവർത്തന ചോദ്യങ്ങൾ"] },
  { title: "Kerala History MCQ", tag: "Kerala History", pdf: `${E:\series\9-1-1}Kerala_History_MCQ.pdf`, topics: ["കേരള ചരിത്രം", "സംഭവ വർഷങ്ങൾ", "പ്രമുഖ വ്യക്തികൾ"] },
  { title: "Kerala History MCQs", tag: "Kerala History", pdf: `${E:\series\9-1-1}kerala_history_mcqs.pdf`, topics: ["കേരള ചരിത്രം", "മുൻവർഷ ചോദ്യ മാതൃക"] },
  { title: "Kerala History MCQs - Set 2", tag: "Kerala History", pdf: `${E:\series\9-1-1}kerala_history_mcqs (2).pdf`, topics: ["കേരള ചരിത്രം", "മാരത്തൺ റിവിഷൻ"] },
  { title: "KERALA HISTORY MARATHON", tag: "Kerala History", pdf: `${E:\series\9-1-1}KERALA HISTORY -MARATHON.pdf`, topics: ["കേരള ചരിത്രം", "മുഴുവൻ റിവിഷൻ", "പ്രധാന PSC facts"] },
  { title: "Indian History MCQ", tag: "Indian History", pdf: `${E:\series\9-1-1}indian_history_mcq.pdf`, topics: ["ഇന്ത്യൻ ചരിത്രം", "സ്വാതന്ത്ര്യ സമരം", "ദേശീയ പ്രസ്ഥാനം"] },
  { title: "Indian History Quiz", tag: "Indian History", pdf: `${E:\series\9-1-1}indian_history_quiz.pdf`, topics: ["ഇന്ത്യൻ ചരിത്രം", "MCQ practice"] },
  { title: "Indian History Exam Questions", tag: "Indian History", pdf: `${E:\series\9-1-1}Indian_History_Exam_Questions.pdf`, topics: ["മുൻവർഷ ചോദ്യം", "ചരിത്രം"] },
  { title: "ഇന്ത്യൻ ചരിത്രം FULL REVISION", tag: "Indian History", pdf: `${E:\series\9-1-1}ഇന്ത്യൻ  ചരിത്രം FULL REVISION (2).pdf`, topics: ["ഇന്ത്യൻ ചരിത്രം", "Malayalam notes", "Full revision"] },
  { title: "December 2025 Current Affairs 50 MCQs", tag: "Current Affairs", pdf: `${E:\series\9-1-1}December_2025_CA_50_MCQs.pdf`, topics: ["ഡിസംബർ 2025", "Current affairs", "MCQ"] },
  { title: "February CA 2026 Notes", tag: "Current Affairs", pdf: `${E:\series\9-1-1}FEBRUARY CA 2026.pdf`, topics: ["ഫെബ്രുവരി 2026", "Malayalam current affairs"] },
  { title: "February CA 2026 Quiz", tag: "Current Affairs", pdf: `${E:\series\9-1-1}february_ca_2026_quiz.pdf`, topics: ["ഫെബ്രുവരി 2026", "Current affairs quiz"] },
  { title: "March CA 2026 Notes", tag: "Current Affairs", pdf: `${E:\series\9-1-1}MARCH CA 2026.pdf`, topics: ["മാർച്ച് 2026", "Malayalam current affairs"] },
  { title: "March CA 2026 MCQ", tag: "Current Affairs", pdf: `${E:\series\9-1-1}march_ca_2026_mcq.pdf`, topics: ["മാർച്ച് 2026", "Current affairs quiz"] },
  { title: "April CA 2026 Notes", tag: "Current Affairs", pdf: `${E:\series\9-1-1}APRIL CA 2026.pdf`, topics: ["ഏപ്രിൽ 2026", "Malayalam current affairs"] },
  { title: "April 2026 Current Affairs Quiz", tag: "Current Affairs", pdf: `${E:\series\9-1-1}April_2026_Current_Affairs_Quiz.pdf`, topics: ["ഏപ്രിൽ 2026", "Current affairs quiz"] },
  { title: "Malayalam History MCQs", tag: "History Malayalam", pdf: `${E:\series\9-1-1}malayalam_history_mcqs.pdf`, topics: ["മലയാളം", "ചരിത്രം", "PSC MCQ"] },
  { title: "Maths Interest MCQ Explanations", tag: "Maths", pdf: `${E:\series\9-1-1}maths_interest_mcq_explanations (2).pdf`, topics: ["പലിശ", "ഗണിതം", "explanations"] },
  { title: "Math Average Malayalam", tag: "Maths", pdf: `${E:\series\9-1-1}math_average_malayalam.pdf`, topics: ["ശരാശരി", "Malayalam maths"] },
  { title: "Maths Series", tag: "Maths", pdf: `${E:\series\9-1-1}Maths - ശ്രേണികൾ.pdf`, topics: ["ശ്രേണികൾ", "PSC maths"] },
  { title: "Maths Mental Ability 200 Questions", tag: "Maths", pdf: `${E:\series\9-1-1}Maths_Mental_Ability_200_Questions.pdf`, topics: ["mental ability", "200 questions", "reasoning"] },
  { title: "Math Questions With Explanations", tag: "Maths", pdf: `${E:\series\9-1-1}math_questions_with_explanations.pdf`, topics: ["ഗണിതം", "explanations"] },
  { title: "Physics Prelims MCQ", tag: "Physics", pdf: `${E:\series\9-1-1}physics_prelims_mcq.html.pdf`, topics: ["Physics", "prelims", "MCQ"] },
  { title: "English Vocabulary", tag: "English", pdf: `${E:\series\9-1-1}English -Vocabulary.pdf`, topics: ["vocabulary", "English", "PSC"] },
  { title: "10th Level Marked Vocabulary - Part 1", tag: "English", pdf: `${E:\series\9-1-1}10TH_LEVEL_MARKED_VOCABSPEDIA_part1.pdf`, topics: ["10th level", "vocabulary", "marked PDF", "Part 1"] },
  { title: "10th Level Marked Vocabulary - Part 2", tag: "English", pdf: `${E:\series\9-1-1}10TH_LEVEL_MARKED_VOCABSPEDIA_part2.pdf`, topics: ["10th level", "vocabulary", "marked PDF", "Part 2"] },
];
